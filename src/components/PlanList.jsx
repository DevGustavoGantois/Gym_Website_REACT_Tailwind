    ...
    return (
        <section className='flex flex-col lg:flex-row items-center justify-center max-w-[1280px] mx-auto gap-y-4'>
            {plans.map((plan, currentIndex) => {
                ...
                return <div onClick={() => setIndex(currentIndex)} className='w-full md:max-w-[620px] lg:max-w-[405px] rounded-sm px-4 lg:min-h-[550px]' key={currentIndex} data-aos="fade-up" data-aos-offset="200" data-aos-delay={delay}>
                    <div className={`${currentIndex === index ? 'bg-neutral-500 text-white' : 'bg-neutral-400/10 text-neutral-500'} flex justify-center items-center py-[40px]`}>
                        <div className='flex flex-row lg:flex-col gap-x-8 gap-y-8 lg:gap-x-0 items-center py-[40px] px-[30px] lg:min-h-[550px] transition duration-300'>
                        <div>
                        ...
                        <div>
                            ...
                            <button className={`${currentIndex === index ? 'bg-white text-neutral-500' : 'border border-neutral-500'} btn btn-lg rounded-[1px] lg:mx-auto`}>Comece agora</button>
                        </div>
                        </div>
                    </div>
                </div>
